...
| FPC        | Camera sequences           | ✅     | ✅       | Can also contain camera animations.                                                                                                                                 | [FFT](https://github.com/MarkusMaal/FlipnicFileTools)/[FFC](https://gist.githubusercontent.com/MarkusMaal/bc9b2d7497d67cb1a17e1ad1d61ca0eb/raw/cceecf9cc0b287f5879706c9ac4b811a80a27a2c/FlipnicFreecam-public.CT)                 |
...
| LIT        | Light tables               | ✅     | ⚠️       | Controls how the stage is lit. Generation confirmed to be possible with a round-trip unit test.                                                                | [FFT](https://github.com/MarkusMaal/FlipnicFileTools)                     |
...
| MLB        | Menu layout (binary?)      | ✅     | ⚠️       | Used to stitch various textures together to create a menu interface. Generation confirmed to be possible with a round-trip unit test.                     | [FFT](https://github.com/MarkusMaal/FlipnicFileTools)                     |
...
| PSS        | Interleaved audio/video    | ✅     | ⚠️       | Generation works for PAL, NTSC will currently freeze with longer videos                                                                                             | [FBE](https://github.com/MarkusMaal/FlipnicBinExtractor)/[FFS](https://github.com/MarkusMaal/FlipnicFs)/[FFT](https://github.com/MarkusMaal/FlipnicFileTools)                                                    |
...
| SST        | Stage (special?) table     | ⚠️     | ⚠️       | Contains stuff like gimmicks, list of files and event system. Can only generate gimmick tables with existing files (FFT beta). Events not fully reverse engineered. | [FFT](https://github.com/MarkusMaal/FlipnicFileTools)                     |
