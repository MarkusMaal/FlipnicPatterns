...
| LAY        | Layout files               | ⚠️     | ❌       | Defines where the various objects on the stage are located. Some decoding is possible, but unreliable.    | N/A                     |
| LIT        | Light tables               | ❌     | ❌       | Controls how the stage is lit                                                                             | N/A                     |
| LP4        | Flipnic resources          | ⚠️     | ❌       | Can be 2D or 3D and sometimes animated, a bizarre format. Not fully reverse engineered.                   | N/A                     |
...
| SCC        | Source Code Control files  | ⚠️     | ❌       | Development left-overs, unused by the game. Supposedly has timestamps, but those use an unknown encoding. | Microsoft Visual SourceSafe     |
